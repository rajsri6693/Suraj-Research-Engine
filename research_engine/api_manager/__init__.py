...
live-HTTP adapters, and this package's own selection/failover/health/
logging logic (this file's exports below) is unchanged by any of these
integrations. See providers/ for all five adapters,

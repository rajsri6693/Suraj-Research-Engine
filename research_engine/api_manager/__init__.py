...
Claude-Prompts/IMP_10C_FMP_Integration.md, FMP is now a real, live-HTTP
adapter; every other provider (Finnhub, Alpha Vantage, Twelve Data,
...
unchanged by that integration. See providers/ for all five adapters,

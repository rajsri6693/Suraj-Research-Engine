...
Fundamental Data Category requests -- Orders & Contracts is Primary
...
OrderContractResult as every prior phase, so every existing caller and
...
OrderContractResult's individual typed fields is future work outside
this phase's scope.
...
class OrdersContractsCollector(BaseCollector):
    ...
    FMP_OPERATION = "Orders & Contracts"
